"""
URL configuration for auto_triage project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Auto Triage API",
        default_version='v1',
        description="API documentation for Auto Triage system",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="contact@autotriage.com"),
