...
from .models import AppointmentType, Appointment, AppointmentFollowUp, AppointmentReminder, AppointmentWaitlist, AppointmentDesire
...
@admin.register(AppointmentDesire)
class AppointmentDesireAdmin(admin.ModelAdmin):
    list_display = ['patient', 'want_appointment', 'created_at']
    list_filter = ['want_appointment', 'created_at']
